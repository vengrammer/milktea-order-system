   ...
   <div className="flex flex-col md:flex-row items-center justify-between max-w-screen px-5 my-8">
      ...
      <form className="flex items-center w-full max-w-md">
       ...
       <button
          ...
          className=" mt:mt-10 bg-green-600 text-white pr-10 pl-10 font-semibold px-4 py-2 rounded hover:bg-green-800 hover:cursor-pointer transition">
          Add milktea
        </button>
    </div>
        ...
        <div className="bg-white shadow-lg rounded-2xl overflow-hidden w-[260px] max-w-sm p-4 hover:shadow-xl transition-shadow">
          ...
          <div className="mt-4">
            ...
            <div className="mt-4 space-y-2">
              <button className="w-full bg-blue-500 text-white px-4 py-2 rounded hover:bg-yellow-600 transition">
                Edit
              </button>
              <button className="w-full bg-red-500 text-white px-4 py-2 rounded hover:bg-green-600 transition">
                Delete
              </button>
            </div>
          </div>
